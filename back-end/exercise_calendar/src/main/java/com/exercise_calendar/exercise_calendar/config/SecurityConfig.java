    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/user/check-userid/**", "/user/signup", "/reissue", "/user/validateToken", "/exercise/getByDate",
                                        "/exercise/create", "/exercise/details/**", "/exercise/update/**", "/exercise/delete/**","/exercise/getAll/**").permitAll()//엔드포인트는 인증 없이 허용
